/*                  special operators 
   ...
   - Arrow operators 
    ...
    accessing structure members using pointer variable and arrow operator 

    - define structure

    - declaring a pointer to a structure and initializing 

    syntax -  struct  structure_name *  pointer_variable_name = & structure_variable_name 

    - for getting members of a structure using arrow operator
    
    syntax - pointer_variable_name -> member_name

    - for setting members of structure using arrow operator

    syntax-   pointer_variable_name -> member_name = value ;
